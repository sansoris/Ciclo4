                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="text-bg">
                            ...
                            <a href="/contacto" class ="enlaceboton" >Contáctenos</a> <a href="/recomendar">Recomendar </a>
                        </div>
                    </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <br/>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="text-bg">
                            <span>Quienes somos </span>
                                ...
                                <a href="/contacto" class ="enlaceboton">Contáctenos</a> <a href="/recomendar" class ="enlaceboton">Recomendar </a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <img
